...
target = imread('C:\Users\tosta\OneDrive\Área de Trabalho\Tosta et al. 2024\target.bmp'); %Parameter: Target image for normalization (the sample is from Glas challenge: Sirinukunwattana, Korsuk et al. Gland segmentation in colon histology images: The glas challenge contest. Medical image analysis, v. 35, p. 489-502, 2017.)
...
folder = 'C:\Users\tosta\OneDrive\Área de Trabalho\Tosta et al. 2024\samples'; %The source image folder (the samples are from Dong, Fei et al. Computational pathology to discriminate benign from malignant intraductal proliferations of the breast. PloS one, v. 9, n. 12, p. e114885, 2014.)
